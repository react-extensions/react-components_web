    ...
    * */
    ...
    render() {
        ...
        const renderTBody = (columns, tType) => {
            ...
            let rows = tType === 'bottom' ? props.fixedRows : props.rows
            // 表格排序
            ...
            return (
                <React.Fragment>
                    {props.loading && tType === 'normal' ? <Icon type='loading' /> : null}
                    {
                        (rows && rows.length > 0)
                            ? (
                                ...
                                <tbody>
                                    {rows.map((tr, i) => (
                                        <Row
                                            ...
                                            isFixed={tType !== 'normal' && tType !== 'bottom'}
                                            isBottom={tType === 'bottom'}
