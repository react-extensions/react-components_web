...
class Table extends React.Component {
  ...
  * */
  analyseCols() {
    ...
    this.colMinZoomWidthList = [...colMinRenderWidthList]
  ...
  * */
  ...
  render() {
    ...
    return (
      /* 总容器 */
      <div className={'u-table__container ' + (this.props.className || '')} ref={el => {this.container = el }} style={{opacity: this.state.complete ? 1: 0}}>
        {/* 调整宽度的标记线 */}
...
Table.propTypes = {
  ...
  scrollY: PropTypes.number,    // 表格体高度
