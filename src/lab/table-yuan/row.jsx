...
class Row extends React.Component {
    ...
    render() {
        ...
        return props.isBottom
            ...
            : (
                <React.Fragment>
                    <tr className={cn('u-tr', props.bgColor, (state.isHover || state.isChecked) && '_active', props.disabled && '_disabled')}
                        ...
                        !state.isCollapse && (
                            <tr className='u-expand-tr'
                                ...
                                <td colSpan={props.columns.length} className='u-expand-td'>
                                    {!props.isFixed ?
                                        <ExpandRow content={state.expandContent} rowData={props.rowData}/> : null}
                                </td>
                            </tr>
                        )
                    }
